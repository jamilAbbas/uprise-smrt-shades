          ...
          >
            ...
            {this.state.showPrice ? (
              <Tag
                classNam="priceDiv"
                color="magenta"
                style={{ marginLeft: 350, position: "absolute", top: 6 }}
              >
                  ...
                  <Input
                    ...
                    addonAfter={
                      ...
                      >
                        ...
                        <Option
                          value="1/8"
                          onClick={() => this.setPrice(17)}
                        >
                          1/8
                            </Option>
                        <Option
                          value="1/4"
                          onClick={() => this.setPrice(18)}
                        >
                          1/4
                            </Option>
                        <Option
                          value="3/8"
                          onClick={() => this.setPrice(19)}
                        >
                          3/8
                            </Option>
                        <Option
                          value="1/2"
                          onClick={() => this.setPrice(21)}
                        >
                          1/2
                            </Option>
                        <Option
                          value="5/8"
                          onClick={() => this.setPrice(22)}
                        >
                          5/8
                            </Option>
                        <Option
                          value="3/4"
                          onClick={() => this.setPrice(23)}
                        >
                          3/4
                            </Option>
                        <Option
                          value="7/8"
                          onClick={() => this.setPrice(24)}
                        >
                          7/8
                            </Option>
                      </Select>
